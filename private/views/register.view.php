    ...
    <form method="post">
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="text"  name="first_name" class="form-control" value="<?= getValue('first_name') ;?>" placeholder="Enter your first name" >
            </div>
        </div>
        <div class="mb-3">
            <div class="input-group">
                <span class="input-group-text"><i class="fas fa-user"></i></span>
                <input type="text" name="last_name" class="form-control" value="<?= getValue('last_name') ;?>" placeholder="Enter your last name" >
            </div>
        </div>
        <div class="mb-3">
            <div class="input-group">
                <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                <input type="email" class="form-control" value="<?= getValue('email') ;?>" name="email" placeholder="you@example.com" >
            </div>
        </div>
        <div class="mb-3">
            <div class="input-group">
        ...
        <div class="mb-3">
            <div class="input-group">
                ...
                <input type="password" class="form-control" <?= getValue('password') ?> name="password" placeholder="Password" >
            </div>
        </div>
        ...
        <div class="mb-3">
            <div class="input-group">
                <span class="input-group-text"><i class="fas fa-lock"></i></span>
                <input type="password" class="form-control" <?= getValue('confirm_password') ?> name="confirm_password" placeholder="Confirm Password" >
            </div>
        </div>
